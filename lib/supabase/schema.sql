...
CREATE POLICY "Enable read access for all users" ON pelatihan FOR
SELECT USING (true);

CREATE POLICY "Enable read access for all users" ON umkm FOR
SELECT USING (true);

CREATE POLICY "Enable read access for all users" ON wisata FOR
SELECT USING (true);