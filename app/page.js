        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <a
                href="/search"
                className=" bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium px-7 py-3 backdrop-blur-lg border border-white/20 shadow-[0_8px_25px_rgba(0,102,204,0.32),inset_0_0_12px_rgba(255,255,255,0.13)] tracking-[0.35px] transition-all duration-200 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50"
              >
                Cari Potensi UMKM
              </a>
          ...
          <div className="glass-card">
            ...
            <div className="mt-6 h-64 bg-linear-to-br from-gray-100 to-white dark:from-zinc-800 dark:to-zinc-900 rounded-lg flex items-center justify-center">
